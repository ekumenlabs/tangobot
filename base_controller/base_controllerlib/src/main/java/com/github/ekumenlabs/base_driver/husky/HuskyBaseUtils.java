 ...
 */
public class HuskyBaseUtils {

    /**
     * Calculates the checksum of a given command package.
     * It assumes the provided buffer has space for the checksum at the end (2 bytes) so those
     * two bytes are not included in the checksum calculation
     *
     ...
     */
    public static char checkSum(byte[] cmdPackage) {
    ...
    public static void main(String args[]) throws Exception {
        System.out.println("--> " + HuskyBaseUtils.byteArrayToString(new byte[] {
                0x14, 0x24, 0x4A, 0x77
        }));

        // Test a couple of known checksum values
        testChecksum("aa0df200080400000004025501000000","d829");
        testChecksum("aa11ee01f40700000004025500000000000000","0dca");
    }
    ...
    // Memory-helper function, only used for debugging
